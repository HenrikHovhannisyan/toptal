                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            <input class="form-control" type="text" id="name" name="name"
                                                placeholder="Name" required minlength="5">
                                            <div class="invalid-feedback">The name must contain at least 5 characters.</div>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <div class="invalid-feedback">Pleaserenter advalidress.</div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="mb-3">
                                                <textarea class="form-control" rows="7" id="message" name="message"
                                                    placeholder="Message" required minlength="10"></textarea>
                                                <div class="invalid-feedback">The message must contain at least 10 characters.</div>
                                            </div>
                                        </div>
...
<script>
    $(document).ready(function() {
        ...
        function validateField(field, minLength = 0, type = 'text') {
            ...
            if (type === 'email') {
                ...
                errorMessage = `Minimum field length ${minLength} characters`;
            }
        ...
        $('#email').on('input', function() {
            validateField(this, 0, 'email');
        });

        $('#message').on('input', function() {
            validateField(this, 10);
        });
        ...
        $('#contactForm').on('submit', function(e) {
            ...
            const nameValid = validateField(document.getElementById('name'), 5);
            const emailValid = validateField(document.getElementById('email'), 0, 'email');
            const messageValid = validateField(document.getElementById('message'), 10);
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        if (response.status === 'success') {
                            $('#contactForm')[0].reset();
                            // Reset styles for all form fields
                            ['name', 'email', 'message'].forEach(fieldId => {
                                resetFieldStyles(document.getElementById(fieldId));
                            });
                        }
                    },
                    error: function(xhr) {
