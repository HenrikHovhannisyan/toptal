                ...
                <div class="row align-items-center">
                    <div class="col-md-8">
                        <div class="work-wrap work-wrap-earning mb-0">
                            <span>03</span>
                            <h1 class="display-6">Get Matched with Developers</h1>
                            <p>
                                Once your job listing is live, you’ll be matched with developers who meet your criteria.
                                You can review profiles, check their skills, experience, and availability, and start the
                                conversation to find the best match for your project. Our platform helps streamline the
                                process, so you can quickly find the developer you need without the hassle.
                            </p>
                        </div>
                    </div>
                    <div class="col-md-4">
